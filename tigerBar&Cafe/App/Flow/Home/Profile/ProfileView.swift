...
class ProfileView: UIView , UITextFieldDelegate{
    ...
    private func setupConstraints() {
        ...
        subTitleLabel.snp.makeConstraints { make in
            make.top.equalTo(btnChangeName.snp.bottom).offset(24)
            make.centerX.equalToSuperview()
        }
        ...
        imgMoneyCont.snp.makeConstraints { make in
            make.top.equalTo(analyticsLabel.snp.bottom).offset(16)
        ...
        cointsMoneyLabel.snp.makeConstraints { make in
            make.top.equalTo(subTitleMoneyLabel.snp.bottom).offset(40)
            make.centerX.equalToSuperview().offset(8)
        }
        
        imgMoneyCoint.snp.makeConstraints { make in
            make.right.equalTo(cointsMoneyLabel.snp.left).offset(-4)
            make.centerY.equalTo(cointsMoneyLabel).offset(-4)
        }
        ...
        imgVisitCont.snp.makeConstraints { make in
            make.top.equalTo(imgMoneyCont.snp.bottom).offset(8)
            make.centerX.equalToSuperview().offset(-91)
        }
        ...
        cointsVisitLabel.snp.makeConstraints { make in
            make.top.equalTo(subTitleVisitLabel.snp.bottom).offset(40)
            make.centerX.equalToSuperview()
        }
        
        imgOrderCont.snp.makeConstraints { make in
            make.top.equalTo(imgDrinkCont.snp.bottom).offset(8)
            make.centerX.equalToSuperview().offset(91)
        }
        ...
        imgTotalCont.snp.makeConstraints { make in
            make.top.equalTo(imgOrderCont.snp.bottom).offset(8)
            make.centerX.equalToSuperview()
        }
